...
//        String projectPath = System.getProperty("user.dir");
        gc.setOutputDir("D:/market-parent/market-service/service-ucenter/src/main/java");
        gc.setAuthor("FQH");
        ...
        strategy.setInclude("tb_user_detail"); // 需要生成的表
    ...
    public void md5Test() throws UnsupportedEncodingException {
        String pwd = "123456";
        String md5Hex1 = DigestUtil.md5Hex(pwd);
    ...
    @Test
    public void testStr() {
        String template = "物品【{}】已经发货";
        String content = StrUtil.format(template, "鸡蛋");
