...
//        String projectPath = System.getProperty("user.dir");
        gc.setOutputDir("D:/market-parent/market-service/service-order/src/main/java");
        gc.setAuthor("FQH");
        ...
        strategy.setInclude("tb_cart_order"); // 需要生成的表
    ...
    public void test2() {
        ...
        System.out.println("雪花id ： " + snowflakeNextIdStr);
        String simpleUUID = IdUtil.simpleUUID();
        System.out.println("uuid: " + simpleUUID);
    }
}
